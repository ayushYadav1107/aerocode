...
export const EnhancedFilePreview: React.FC<EnhancedFilePreviewProps> = ({
  ...
  if (compact) {
    return (
      <div className="flex items-center gap-2 bg-muted/50 rounded-lg p-2 border border-border group hover:bg-muted/70 transition-colors">
          ...
          {showSearch && (
            <div className="p-3 border-b border-border bg-muted/30">
              <Input
                ...
                className="h-8 bg-card/50 border-border"
              />
            </div>
          )}
            ...
            {file.type === "code" ? (
              ...
              <div className="p-4 text-center">
                ...
                <div className="bg-muted rounded p-4">
                  ...
                  <p className="text-xs text-muted-foreground mt-2">Image preview not available</p>
                </div>
              </div>
            ) : (
              <div className="p-4">
                <pre className="text-sm text-foreground whitespace-pre-wrap font-mono bg-card/50 p-3 rounded border border-border max-h-60 overflow-auto">
                  {filteredContent}
                </pre>
              </div>
            )}
