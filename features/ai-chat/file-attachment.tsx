  ...
  if (compact) {
    return (
      <div className="flex items-center gap-2 bg-muted/50 rounded-lg p-2 border border-border">
        ...
        <Button variant="ghost" size="sm" onClick={onRemove} className="h-6 w-6 p-0 text-muted-foreground hover:text-red-400">
          <X className="h-3 w-3" />
        </Button>
      </div>
    )
    ...
    <div className="border border-border rounded-lg overflow-hidden bg-card/50">
      <div className="flex items-center justify-between p-3 bg-muted/50">
        ...
        <div className="flex items-center gap-1">
          ...
          <Button variant="ghost" size="sm" onClick={onRemove} className="h-7 w-7 p-0 text-muted-foreground hover:text-red-400">
...
const CodeSuggestionCard: React.FC<{
  ...
  return (
    <div className="border border-border rounded-lg overflow-hidden bg-muted/30 my-3">
...
export const FileAttachmentChat: React.FC<FileAttachmentChatProps> = ({ isOpen, onClose, onInsertCode }) => {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "fixed right-0 top-0 h-full w-full max-w-5xl bg-background border-l border-border z-50 flex flex-col transition-transform duration-300 ease-out shadow-2xl",
      ...
      >
        ...
        <div className="shrink-0 border-b border-border bg-card/80 backdrop-blur-sm">
          <div className="flex items-center justify-between p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg font-semibold text-foreground">AI Code Assistant</h2>
                <p className="text-sm text-muted-foreground">With file attachments & code insertion</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <Button
          ...
          <div className="p-6 space-y-6">
            {messages.length === 0 && !isLoading && (
              <div className="text-center text-muted-foreground py-16">
                ...
                <h3 className="text-xl font-semibold mb-3 text-foreground">AI Code Assistant</h3>
                ...
                <div className="flex flex-wrap justify-center gap-2">
                  {[
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 bg-muted hover:bg-muted rounded-full text-sm text-foreground transition-colors"
                    >
                      {suggestion}
                    </button>
                  ))}
              ...
              <div key={index} className="space-y-4">
                ...
                >
                  ...
                  <div
                    className={cn(
                      ...
                      msg.role === "user"
                        ? "bg-muted text-white p-4 rounded-br-md"
                        : "bg-card/80 backdrop-blur-sm text-foreground p-5 rounded-bl-md border border-border",
                    )}
                  >
                ...
                {msg.role === "assistant" && msg.suggestions && msg.suggestions.length > 0 && (
                  <div className="ml-14 space-y-2">
                    <div className="text-sm font-medium text-foreground mb-3">💡 Code Suggestions:</div>
            ...
            {isLoading && (
              <div className="flex items-start gap-4 justify-start">
                ...
                <div className="bg-card/80 backdrop-blur-sm border border-border p-5 rounded-xl rounded-bl-md flex items-center gap-3">
                  <Loader2 className="h-4 w-4 animate-spin text-blue-400" />
                  <span className="text-sm text-foreground">Analyzing code...</span>
                </div>
              </div>
            )}
        ...
        {attachments.length > 0 && (
          <div className="shrink-0 border-t border-border bg-card/50 p-4">
            <div className="text-sm font-medium text-foreground mb-3">Attached Files ({attachments.length})</div>
        ...
        <form
          ...
          className="shrink-0 p-4 border-t border-border bg-card/80 backdrop-blur-sm"
        >
          <div className="flex items-end gap-3">
            <div className="flex-1 relative">
              <Textarea
                ...
                disabled={isLoading}
                className="min-h-[44px] max-h-32 bg-muted/50 border-border text-foreground placeholder:text-muted-foreground focus:border-blue-500 focus:ring-blue-500/20 resize-none"
                rows={1}
              />
              <div className="absolute right-3 bottom-3 flex items-center gap-2">
                ...
                <kbd className="hidden sm:inline-block px-1.5 py-0.5 text-xs text-muted-foreground bg-muted border border-border rounded">
                  ⌘↵
                </kbd>
              </div>
            </div>
